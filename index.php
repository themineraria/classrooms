    ...
    <body class=" " data-smooth-scroll-offset='64'>
                        ...
                        <div class="col-lg-11 col-md-12 text-right text-left-xs text-left-sm">
                            <div class="bar__module">
                                <ul class="menu-horizontal text-left">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-12 dropdown__content dropdown__content--lg">
                                                        <div class="pos-absolute col-lg-5 bg--secondary hidden-sm hidden-xs" data-overlay="4">
                                    ...
                                    <li class="dropdown">
                                        <span class="dropdown__trigger">Catégories</span>
                                        <div class="dropdown__container">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-12 dropdown__content dropdown__content--lg">
                                                        <div class="pos-absolute col-lg-5 bg--dark">
                                                            <div class="container pos-vertical-center pl-5">
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <span class="h3 color--white">Catégories plus détaillées que jamais</span>
        ...
        <div class="main-container">
            <section class="height-100 imagebg parallax" data-overlay="6">
                <div class="background-image-holder">
                    <img alt="background" src="img/drone-3.jpg" />
                </div>
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>Le meilleur endroit pour
                                <span class="inline-block typed-text typed-text--cursor color--primary" data-typed-strings="apprendre,enseigner,gagner de l'argent,dépenser son temps,s'entraider,changer de vie">accommodation</span>
                                <br class="hidden-xs">avec 9'471 cours.</h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="cta cta-1 cta--horizontal boxed boxed--border text-center-xs">
                                <div class="row justify-content-center p-5">
                                    <div class="col-lg-3">
                                        <h4>Essayer pendant 14 jours</h4>
                                    </div>
                                    <div class="col-lg-4">
                                        <p class="lead">
            ...
            <section class="imageblock switchable feature-large bg--secondary space--sm">
                <div class="imageblock__content col-lg-6 col-md-4 pos-right">
                    <div class="background-image-holder">
                        <img alt="image" src="img/education-4.jpg" />
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-7">
                            <h2>Comme dans une université...</h2>
                            <p class="lead">
                                Nous vous offrons la possibilité de suivre la matière de votre choix, au moment de votre choix. Suivre vos cours comme à l'univesrité, mais en petit comité, pouvoir poser des questions, motive encore plus que de lire une page internet. Apprenez plus en moins de temps.
                            </p>
                        </div>
                    </div>
                    <!--end of row-->
            ...
            <section class="imageblock switchable switchable--switch feature-large bg--secondary space--sm">
                <div class="imageblock__content col-lg-6 col-md-4 pos-right">
                    <div class="background-image-holder">
                        <img alt="image" src="img/education-3.jpg" />
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-7">
                            <h2>...ou comme en classe...</h2>
                            <p class="lead">
                                Grâce à notre forum d'aide aux devoirs, vous pouvez poser n'importe quelle question et obtenir une réponse en moins de dix minutes. Vous pouvez même aider vos camarades de classe, ou poser la question à des professionnels.
                            </p>
                        </div>
                    </div>
                    <!--end of row-->
            ...
            <section class="imageblock switchable feature-large bg--secondary space--sm">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-7">
                            <h2>...ou comme n'importe où dans le monde</h2>
                            <p class="lead">
                                Pas besoin de transporter vos trente kilos de matériel scolaire. Rendez-vous simplement sur un ordinateur, tablette ou smartphone pour accéder à tous vos cours, et même participer à de nouveaux.
                            </p>
                        </div>
                    </div>
                    <!--end of row-->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="pricing pricing-1 boxed boxed--lg boxed--border">
                                ...
                                <span class="type--fine-print">Par mois, toutes taxes incluses</span>
                                <hr>
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <span class="checkmark bg--primary-1"></span>
                                        <span>Cours à points</span>
                                    </li>
                                    <li>
                                        <span class="checkmark bg--primary-1"></span>
                                        <span>Aide aux devoirs à points</span>
                                    </li>
                                    <li>
                                        <span class="checkmark bg--primary-1"></span>
                        ...
                        <div class="col-md-4">
                            <div class="pricing pricing-1 boxed boxed--lg boxed--border boxed--emphasis">
                                <h3>Premium (1 an)</h3>
                                <span class="h2">
                                    <strong>CHF 80</strong>
                                </span>
                                <span class="type--fine-print">Par an, toutes taxes incluses</span>
                                <span class="label">Value</span>
                                <hr>
                                <ul>
                                    <li>
                                        <span class="checkmark bg--primary-2"></span>
                                        <span>24/7 Assistance</span>
                                    </li>
                                    <li>
                                        <span class="checkmark bg--primary-2"></span>
                                        <span>Aide aux devoirs illimitée</span>
                                    </li>
                                    <li>
                                        <span class="checkmark bg--primary-2"></span>
                                    ...
                                    <li>
                                        <span class="checkmark bg--primary-2"></span>
                                        <span>Cours audio en direct</span>
                                    </li>
                                </ul>
                                <a class="btn btn--primary-2" href="#">
                                    <span class="btn__text">
                                        Ajouter au panier
                                    </span>
                                </a>
            ...
            <section class="space--md">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="height-60 imagebg border--round" data-overlay="4">
                                <div class="background-image-holder">
                                    <img alt="background" src="img/inner-6.jpg">
                                </div>
                                <div class="pos-vertical-center col-md-6 boxed boxed--lg bg--none">
                                    <h2>Rejoignez le monde de l'enseignement</h2>
                                    <p class="lead">
                                        Avec nous, prenez la casquette d'un enseignant diplômé, et distribuez vos connaissances aux quatres coins du monde, tout en gagnant de l'argent. Pas besoin d'entretien d'embauche, il vous suffit de créer un compte.
                                    </p>
                                    <a href="#" class="btn btn--primary type--uppercase">
                                        <span class="label bg--primary-2">Inscription gratuite</span>
                                        <span class="btn__text">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <span class="type--fine-print">©
                                <span class="update-year">2018</span> Classrooms Sàrl</span>
                            <a class="type--fine-print" href="#">Politique de confidentialité</a>
                            <a class="type--fine-print" href="#">Impressum</a>
                        </div>
